...
def visualize(dfs, n_data, label_names, dataset_name):
    visualize_classes(
        dfs,
        label_names,
        "std",
        f"{dataset_name} (n={n_data}) classes with added gaussian noise"
    )
    visualize_scores(
        dfs,
        ["AMI", "ARI"],
...
def main(argv):
    ...
    visualize(dfs, n_data, label_names, dataset_name)
